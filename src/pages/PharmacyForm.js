                ...
                <form className='Form' name='myForm' onSubmit={validateForm}>
                    ...
                    <div className='FormHeader'>
                        <div className='TopLeft'>
                            <div className='TopLeftHeader'>PHARMACY APPLICATION FORM</div>
                    ...
                    <div className='Tab' id='Tab'>
                        <div className='PersonalInformation'>
                            ...
                            <div className='Input4'>
                                <div className='Label' type="email" id='email' onChange={(e) => setEmail(e.target.value)}>Email Address</div><br></br>
                                <input type="email" />
                            </div>
